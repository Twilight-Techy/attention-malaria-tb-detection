...
# Raw dataset locations (Kaggle input mounts). Adjust these paths if the datasets are mounted differently.
malaria_data_path = '/kaggle/input/datasets/iarunava/cell-images-for-detecting-malaria/cell_images/cell_images'
if not os.path.exists(malaria_data_path):
    malaria_data_path = '/kaggle/input/datasets/iarunava/cell-images-for-detecting-malaria/cell_images'
    if not os.path.exists(malaria_data_path):
        malaria_data_path = '/kaggle/input/datasets/iarunava/cell-images-for-detecting-malaria'
